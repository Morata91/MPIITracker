...
class MPIITrackerModel(nn.Module):
    ...
    def forward(self, faces, eyesLeft, eyesRight, faceGrids, eyeGrids):
        ...
        eG = self.eyeGridModel(eyeGrids)

        # Cat all
        x = torch.cat((xEyes, xFace, xGrid, eG), 1)
