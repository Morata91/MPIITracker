...
CP_PATH = 'checkpoints/202312221055'
    ...
    # for fold in range(len(cp_fold_list)):
        ...
        with open(os.path.join(evallogpath, 'eval.log'), 'w') as outfile:
            ...
            for epochs in folder: 
                ...
                evaluation(test_loader, model, log_file_path, fold, idx_tensor_x, idx_tensor_y)
...
def evaluation(test_loader, model, log_file_path, fold, idx_tensor_x, idx_tensor_y,):
    ...
    for i, (row, imFace, imEyeL, imEyeR, faceGrid, gaze, binned_x, binned_y) in enumerate(test_loader):
        try:
            with open(log_file_path, "a") as logfile:
                ...
                # compute output
                with torch.no_grad():
                    x, y = model(imFace, imEyeL, imEyeR, faceGrid)
